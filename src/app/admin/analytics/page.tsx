    ...
    <div className="min-h-screen bg-paper">
      <main className="mx-auto w-full max-w-6xl px-5 py-8 sm:py-10">
        <p className="flex flex-wrap gap-x-4 gap-y-1 text-sm text-ink-soft">
          <Link href="/admin/operations" className="font-medium hover:text-ink">
            ‹ Operations
          </Link>
          <Link href="/admin/leads" className="font-medium hover:text-ink">
            Setup requests
          </Link>
        </p>
        ...
        <div className="mt-6 grid grid-cols-2 gap-2.5 sm:grid-cols-3 lg:grid-cols-6 sm:gap-3">
          {[
        ...
        <section aria-label="Conversion funnel" className="mt-8">
        ...
        <section aria-label="CTA locations" className="mt-8">
