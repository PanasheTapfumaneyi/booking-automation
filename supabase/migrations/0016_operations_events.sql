...
COMMENT ON TABLE operations_events IS 'Lightweight operations monitoring for booking funnel, failures, and provider health. Privacy-conscious: no tokens, credentials, or unnecessary PII.';
